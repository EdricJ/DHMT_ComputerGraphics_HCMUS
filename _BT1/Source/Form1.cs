...
namespace lab1
{
    public partial class Form1 : Form
    {
        ...
        public class Config
        {
            ...
            public const int RANDOM = -1, LINE = 0, CIRCLE = 1, RECTANGLE = 2, TRIANGLE = 3, ELLIPSE = 4, PENTAGON = 5, HEXAGON = 6;
            public const int DISTANCE_POINT = 10; // khoang cach lon nhat giua diem select va diem control
        }
        ...
        private void openGLControl_OpenGLInitialized(object sender, EventArgs e)
        {
            ...
            OpenGL gl = openGLControl.OpenGL;
            // Set the clear color.
            gl.ClearColor(176.0f, 226.0f, 255.0f, 0.0f); //màu cho openGLControl  
        ...
        private void form1_openGLControl_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            else if (rd_bt_Select.Checked)
            {
                ...
                //kiểm tra trước điểm chọn với ellipse 
                if (!selected)
                {
